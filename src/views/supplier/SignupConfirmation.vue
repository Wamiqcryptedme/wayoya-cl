<template>
  <div class="flex flex-col min-h-screen bg-brand-bg">
    ...
    <main class="flex-1 flex items-center justify-center p-4 pb-32 py-12 md:py-[70px] md:p-8 overflow-y-auto">
      ...
      <!-- Confirmation Card -->
      <div class="w-full max-w-3xl bg-white rounded-xl border border-gray-200 py-10 md:py-12 p-5 md:p-6 animate-fade-in-up">
        
        <!-- Check Icon -->
        <div class="w-12 h-12 bg-brand-tealLight rounded-full flex items-center justify-center mb-3">
        ...
        <!-- What's Next Section -->
        <div class="mb-8">
          <h3 class="text-base font-semibold text-brand-dark mb-2">What's next</h3>
          <ul class="space-y-3">
            <li class="flex items-start">
              <svg class="w-5 h-5 text-brand-teal mr-2 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div>
          <h3 class="text-base font-semibold text-brand-dark mb-2">Review process</h3>
