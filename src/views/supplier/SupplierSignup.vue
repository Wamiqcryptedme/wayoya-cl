...
const finishOnboarding = async () => {
  ...
  try {
    ...
    // ============================================
    // STEP 1: SIGN UP USER FIRST (Get auth.uid())
    // ============================================
    ...
    // ============================================
    // STEP 2: NOW Upload Documents (with real user ID)
    // ============================================
    ...
    if (formData.category === 'Stay' && propertyPhotoFiles.value.length > 0) {
      console.log('📸 Uploading propertyphotos...');
...
// ============================================
// STEP 4: Prepare & Store Onboarding Data
// ============================================
